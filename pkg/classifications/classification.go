...
func Call(i int) classificationCode {
	...
	case As:
		...
		tc.description = "The world is an asteroid belt which is primary world or mainworld in the system. It is producer of raw materials and semi-finished goods, especialy ores, metals and minerals."
	case De:
		tc.code = "De"
		tc.classification = "Desert"
		tc.tcType = TypePlanetary
	...
	case Fl:
		...
		tc.tcType = TypePlanetary
		tc.description = "The world's oceans are not composed of water. Non-water oceans mat be valuable sources of raw materials for industry."
	case Ga:
		tc.code = "Ga"
		tc.classification = "Garden World"
		tc.tcType = TypePlanetary
		tc.description = "The world is hospitable for most sophonts. It's size, atmosphere and hydrographic makes it extremly atractive world. A Garden World has a safe environment which does not require protective equipment for humans and sophonts which share the human environment."
	case He:
		tc.code = "He"
		tc.classification = "Hellworld"
		tc.tcType = TypePlanetary
		tc.description = "The world is inhospitable for most sophonts. It's size, atmosphere and hydrographic makes it extremly unatractive world."
	case Ic:
		tc.code = "Ic"
	...
	case Oc:
		...
		tc.tcType = TypePlanetary
		tc.description = "The world surface is covered with very deep seas. There is no (less than hundredth) land above sea level."
	case Va:
		tc.code = "Va"
