...
func TestStationsReport(t *testing.T) {
	...
	for _, data := range []string{
		...
		if report.Present[Type_ANY] != report.Present[Type_Naval]+report.Present[Type_Paramilitary]+report.Present[Type_Commercial]+report.Present[Type_Civilan]+report.Present[Type_Imperial]+report.Present[Type_Pirate] {
