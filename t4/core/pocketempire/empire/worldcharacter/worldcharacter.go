...
// 	dm := 0
// 	if wc.uwp.Data(profile.KEY_POPS).Value() >= 6 {
// 		dm++
// 	}
// 	if wc.uwp.Data(profile.KEY_POPS).Value() >= 9 {
// 		dm++
// 	}
// 	if wc.uwp.Data(profile.KEY_LAWS).Value() >= 10 {
// 		dm++
// 	}
...
// 	dm := 0
// 	if wc.uwp.Data(profile.KEY_LAWS).Value() <= 4 {
// 		dm = dm + 1
// 	}
// 	if wc.uwp.Data(profile.KEY_LAWS).Value() >= 10 {
// 		dm = dm - 1
// 	}
// 	if wc.uwp.Data(profile.KEY_GOVR).Value() <= 2 {
// 		dm = dm + 1
// 	}
// 	if wc.uwp.Data(profile.KEY_GOVR).Value() == 7 {
// 		dm = dm + 3
// 	}
// 	if wc.uwp.Data(profile.KEY_GOVR).Value() == 15 {
// 		dm = dm - 1
// 	}
// 	if wc.Attitude(GROWTH_STAT) == PASSIVE_Growth {
// 		dm = dm + 2
...
// 	dm := 0
// 	if wc.uwp.Data(profile.KEY_PORT).Code() == "A" {
// 		dm = dm - 2
// 	}
// 	if wc.uwp.Data(profile.KEY_PORT).Code() == "B" {
// 		dm = dm - 1
// 	}
// 	if wc.uwp.Data(profile.KEY_PORT).Code() == "D" {
// 		dm = dm + 1
// 	}
// 	if wc.uwp.Data(profile.KEY_PORT).Code() == "E" {
// 		dm = dm + 3
// 	}
// 	if wc.Attitude(PROGRESSION_STAT) == CONSERVATIVE_Progression {
// 		dm = dm + 2
...
// 	s += fmt.Sprintf("UWP  : %v-%v\n", profile.UWP(wc.uwp), wc.econEx.String())
// 	s += fmt.Sprintf("HEX  : %v\n", wc.Location())
// 	s += fmt.Sprintf("PBG: : %v\n", wc.PBG())
...
// 	return profile.UWP(wc.uwp) + "-" + wc.econEx.String()
// }

// func (w *world) EstimatedPopulation() float64 {
// 	return float64((10^w.uwp.Data(profile.KEY_POPS).Value())*w.popMod) / 1000000.0
// }
...
// 	actionBonus := 0
// 	leadershipBonus := 0
// 	t := w.uwp.Data(profile.KEY_TL).Value()
// 	c := w.econEx.Culture()
// 	i := w.econEx.Infrastructure()
// 	l := abs(w.uwp.Data(profile.KEY_LAWS).Value() - w.SelfDetermination())
// 	g := abs(pluralism(w.uwp.Data(profile.KEY_GOVR).Value()) - w.SelfDetermination())
